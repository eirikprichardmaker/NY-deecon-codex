...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--mos-grid", default="0.30,0.35")
    p.add_argument("--mad-grid", default="-0.08")
    p.add_argument("--mad-penalty-k-grid", default="0.0,0.5,1.0")
    p.add_argument("--min-hold-grid", default="6")
    p.add_argument("--score-gap-grid", default="0.25")
